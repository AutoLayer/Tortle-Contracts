...
contract SpookyToken is ERC20Permit, Ownable {
    ...
    uint256 private constant _maxTotalSupply = 1366600000000e18; // 13,666,000 max spooks
...
contract MasterChef is Ownable {
    ...
    constructor(SpookyToken _boo, uint256 _booPerSecond) {
        boo = _boo;
        devaddr = msg.sender;
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken) external onlyOwner {
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardTime: lastRewardTime, accBOOPerShare: 0}));
    }
